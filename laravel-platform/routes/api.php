...
|   2. Storefront routes (per store, no auth)
|   3. Dashboard routes (merchant authenticated)
|   4. Admin routes (platform admin)
|
*/
...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('store/{store}')->group(function () {
        ...
        // Store info
        Route::get('/', [StoreController::class, 'publicInfo']);
        ...
        Route::get('/products/{product}', [ProductController::class, 'storeProduct']);
        Route::get('/products/{product}/related', [ProductController::class, 'related']);

        // Categories
        Route::get('/categories', [ProductController::class, 'categories']);
        Route::get('/categories/{category}', [ProductController::class, 'categoryProducts']);
        ...
        Route::get('/orders/{tracking}', [OrderController::class, 'trackOrder']);
        ...
        // Pixels (for storefront to load tracking scripts)
        Route::get('/pixels', [PixelController::class, 'activePixels']);
    });

    // ═══════════════════════════════════════════════════════════════
    // 3. DASHBOARD ROUTES (Authenticated Merchant/Staff)
    // ═══════════════════════════════════════════════════════════════
    ...
    Route::prefix('dashboard')->middleware(['auth:sanctum'])->group(function () {
        ...
        Route::put('/shipping/rules/{id}', [ShippingController::class, 'updateRule']);
    ...
    // ═══════════════════════════════════════════════════════════════
    // 4. ADMIN ROUTES (Platform Super Admin)
    // ═══════════════════════════════════════════════════════════════
