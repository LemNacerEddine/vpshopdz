...
const AdminLayout = ({ children }) => {
  ...
  const [expandedMenus, setExpandedMenus] = useState(() => {
    if (typeof window !== 'undefined') {
      ...
      if (path.startsWith('/admin/orders') || path.startsWith('/admin/abandoned-checkouts')) {
        initial.push('orders');
      }
  ...
  const l = {
    ar: {
      ...
      abandonedCheckouts: 'الطلبات المتروكة',
    ...
    fr: {
      ...
      shippingRules: 'Règles de livraison',
      taxes: 'Taxes',
      users: 'Utilisateurs',
      marketing: 'Marketing',
      search: 'Rechercher...',
  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: text.abandonedCheckouts, path: '/admin/abandoned-checkouts' },
    ...
    },
    {
      ...
      children: [
        ...
        { label: text.marketing, path: '/admin/settings/marketing' },
        { label: text.shipping, path: '/admin/shipping' },
        { label: text.shippingRules || text.shipping, path: '/admin/shipping/rules' },
        { label: text.taxes, path: '/admin/settings/taxes' },
        { label: text.notifications, path: '/admin/settings/notifications' },
  ...
  const hasActiveChild = (menuId) => {
    ...
    switch (menuId) {
      ...
      case 'orders':
        return path.startsWith('/admin/orders') || path.startsWith('/admin/abandoned-checkouts');
      case 'finance':
