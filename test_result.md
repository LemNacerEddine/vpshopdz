...
agent_communication:
  ...
  - agent: "testing"
    message: |
      ...
      - ✅ External URL Testing: All tests performed using production URL https://vpshopdz.preview.emergentagent.com
