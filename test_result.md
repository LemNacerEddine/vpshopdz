...
agent_communication:
  ...
  - agent: "testing"
    message: |
      ...
      - ✅ External URL Testing: All tests performed using production URL https://php-migration-15.preview.emergentagent.com
