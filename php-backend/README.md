...
api/seed:1  Failed to load resource: the server responded with a status of 404 (Not Found)
api/cart:1  Failed to load resource: the server responded with a status of 404 (Not Found)
...
$basePath = '/agro-store/api'; // Adjust based on your setup
